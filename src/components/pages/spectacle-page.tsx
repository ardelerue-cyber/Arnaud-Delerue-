...
import { canReserveEvent, formatDateFR, getNextPublicEvent } from "@/lib/format";
...
export function SpectaclePageClient() {
      ...
      <div className="relative flex flex-col gap-20">
          ...
          <div className="relative flex min-h-[80vh] flex-col justify-end px-6 pb-16 pt-24 sm:px-10">
            ...
            >
              <Badge className="mb-5">
                {nextEvent ? "Prochaine date" : "Programmation 2026"}
              </Badge>
        ...
        <section className="grid gap-8 md:grid-cols-[1.1fr_1fr] md:items-start">
          ...
          >
            ...
            <div className="mt-4 space-y-4 text-sm leading-relaxed text-neutral-300 sm:text-base">
              ...
              <CardContent className="flex h-full flex-col items-start justify-between gap-6">
                <div>
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-neutral-400 sm:text-base">
                    Disponibilités, dossier et fiche technique sur demande.
                  </p>
        ...
        <section className="grid gap-4">
          ...
          >
            <h2 className="text-3xl font-[var(--font-display)] text-white sm:text-4xl lg:text-3xl">
              {nextEvent ? "Prochaine date" : "Nouvelles dates à venir"}
            </h2>
            <Separator className="my-4 bg-white/10" />
          </motion.div>
          <motion.div
                  ...
                  {nextEvent ? (
                    <>
                      <div className="text-sm text-neutral-400">
                        {formatDateFR(nextEvent.dateTime)}
                      </div>
                    ...
                    <>
                      ...
                      <div className="mt-2 text-lg font-[var(--font-display)] text-white">
                        Inscrivez-vous pour être informé ou contactez-nous pour une
                        programmation.
                      </div>
                    </>
                  )}
